...
from vlab_inventory_api.lib.views import healthcheck
...
class TestHealthView(unittest.TestCase):
    ...
    def test_get(self):
        """HealthView for /api/1/inf/inventory/heathcheck supports GET"""
        resp = self.app.get('/api/1/inf/inventory/healthcheck')
